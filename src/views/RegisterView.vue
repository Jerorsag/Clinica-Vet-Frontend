  ...
  <div class="min-h-screen bg-gradient-to-b from-teal-50 to-emerald-100 py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
    <div class="max-w-md w-full bg-white rounded-xl shadow-2xl overflow-hidden">
      ...
      <div class="bg-emerald-600 py-6 relative">
        ...
        <p class="text-center text-emerald-100 mt-1">Únete a la familia de Clínica Veterinaria</p>
      </div>
      ...
      <div class="p-6">
        <form @submit.prevent="handleRegister" class="space-y-4">
          ...
          <button 
            type="submit" 
            class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-emerald-600 hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-colors duration-150 ease-in-out shadow-md mt-4"
            :disabled="isLoading"
          >
            <span class="absolute left-0 inset-y-0 flex items-center pl-3" v-if="!isLoading">
              <CircleCheck class="h-5 w-5 text-emerald-500 group-hover:text-emerald-400"/>
            </span>
        ...
        <div class="flex justify-center space-x-2 mt-4 text-emerald-500">
          <Cat class="w-5 h-5" />
